...
inline void addVectors(struct point3D *a, struct point3D *b)
{
 ...
 b->py=b->py+a->py;
 b->pz=b->pz+a->pz;
 b->pw=0;               // Mind the homogeneous coordinate!
}
...
bool planeIntersect(struct object3D *plane, struct ray3D *r, double *lambda, struct point3D *p, struct point3D *n, double *a, double *b);
bool sphereIntersect(struct object3D *sphere, struct ray3D *r, double *lambda, struct point3D *p, struct point3D *n, double *a, double *b);
bool cylinderIntersect(struct object3D *sphere, struct ray3D *r, double *lambda, struct point3D *p, struct point3D *n, double *a, double *b);
bool coneIntersect(struct object3D *sphere, struct ray3D *r, double *lambda, struct point3D *p, struct point3D *n, double *a, double *b);
